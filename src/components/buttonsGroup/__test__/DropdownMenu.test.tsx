...
describe("Dropdown menu test", () => {
  ...
  it("Icon Button rendered", async () => {
    ...
    render(<DropdownMenu id={"test-dropdown-menu-id"}><h1>Test</h1></DropdownMenu>)
  ...
  it('When click on Button show Menu', async function () {
    ...
    await expect(screen.getByTestId("action-test-dropdown-menu-id")).toBeInTheDocument()
    ...
    await act(async () => {
      await expect(screen.queryByTestId("action-test-dropdown-menu-id")).not.toBeInTheDocument()
    })
